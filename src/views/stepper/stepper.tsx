...
const Stepper = () => {
  ...
  const handleAddField = () => {
    setFields([
      ...
      { name: "",
        sensors: [""],
        crops: [{ name: "", localName: "", growthStage: "" }] 
      },
    ]);
  };
  ...
  return (
    <Center w="100%">
      ...
      >
        ...
        <Flex direction= {{base:"column", md:"row"}} align={{base:"center", md:""}} justify="space-around" h="600px" p={4} gap="10%" w="100%" mx={{base:"10%"}}>
          <ChakraStepper
            index={activeStep}
            colorScheme="brand"
            size="lg"
        ...
        <Flex  mt={0} w="100%" justifyContent="space-evenly">
          <Button
            colorScheme="teal"
            variant="outline"
